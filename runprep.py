...
aidatac_wiki_toktext_file = os.path.join(config.DATA_DIR, 'aidatac_wiki_toktext_tmp.txt')
aidatac_anchor_cxt_file = os.path.join(config.DATA_DIR, 'aidatac_anchor_cxt_tmp.txt')
