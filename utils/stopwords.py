nltk_stopwords = {
    ...
    "now", "'s", "also", "many", "would", "however"}

deeped_stop_words = {
    "a", "'s", "about", "above", "across", "after", "afterwards", "again", "against", "all", "almost", "alone",
    ...
    "call", "can", "cannot", "cant", "dont", "co", "con", "could", "couldnt", "cry", "de", "describe",
    ...
    "st", "years", "yourselves", "new", "used", "known", "year", "later", "including", "used", "end", "did", "just",
    "best", "using"}
